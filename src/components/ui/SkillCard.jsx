  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={isHovered ? {
          opacity: 1,
          background: "linear-gradient(90deg, transparent, #a855f7, transparent, #ec4899, transparent)",
      ...
      <motion.div 
        className="relative bg-slate-100 dark:bg-slate-800/50 backdrop-blur-sm p-6 rounded-xl border-2 border-purple-500/40 transition-all overflow-hidden h-full"
        // The whileHover scale and y: -5 are moved to the parent motion.div for 3D effect
        transition={{ duration: 0.3 }}
      >
        {/* Animated Background Gradient */}
        <motion.div 
          className="absolute inset-0 bg-gradient-to-br from-purple-500/0 to-pink-500/0 group-hover:from-purple-500/20 group-hover:to-pink-500/20 transition-all duration-500"
          animate={isHovered ? {
            opacity: [0.5, 1, 0.5],
            scale: [1, 1.1, 1]
          } : {
