  ...
  return (
    <section id="timeline" className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <motion.div
            className="inline-block p-4 bg-purple-500/10 rounded-full mb-4"
          ...
          <div className="space-y-12">
            {timelineEvents.map((event, index) => (
              ...
              >
                ...
                >
                  <div className="bg-slate-100 dark:bg-slate-800/20 backdrop-blur-sm rounded-xl p-6 border-2 border-purple-500/40 hover:border-purple-500/50 transition-all group">
                    {/* Year Badge */}
                    <motion.div
                    ...
                    <div className={`flex flex-wrap gap-2 ${
                      ...
                      {event.achievements.map((achievement, i) => (
                        <motion.span
                          ...
                          className="px-3 py-1 text-xs bg-purple-500/10 border-2 border-purple-500/50 rounded-full text-purple-400"
                ...
                >
                  <div className={`p-4 bg-gradient-to-r ${event.color} rounded-full shadow-lg border-4 border-slate-100 dark:border-slate-900`}>
        ...
        >
          <div className="inline-block p-6 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-2xl border-2 border-purple-500/40">
