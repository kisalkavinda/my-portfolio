...
// Helper function to extract info from knowledgeBase
const getInfo = (kb, path) => {
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed right-8 bottom-8 z-50 p-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full shadow-2xl hover:shadow-purple-500/50 transition-all"
      ...
      <AnimatePresence>
        {isChatbotOpen && (
          <motion.div
            className="fixed right-8 bottom-[6.5rem] z-50 w-[90vw] max-w-md bg-slate-100 dark:bg-slate-900 rounded-2xl shadow-2xl border border-purple-500/20 overflow-hidden"
          ...
          >
            ...
            {/* Messages */}
            <div className="h-72 overflow-y-auto p-4 space-y-4 bg-slate-200 dark:bg-slate-800">
              ...
              {isTyping && (
                ...
                >
                  ...
                  <div className="px-4 py-2 bg-slate-100 dark:bg-slate-700 rounded-2xl">
            ...
            {/* Quick Replies */}
            {messages.length <= 2 && ( 
              <div className="p-3 bg-slate-200 dark:bg-slate-800 border-t border-purple-500/20">
                ...
                <div className="flex flex-wrap gap-2">
                  {quickReplies.map((reply, index) => (
                    <motion.button
                      ...
                      className="px-3 py-1 text-xs bg-purple-500/10 hover:bg-purple-500/20 text-purple-600 dark:text-purple-400 rounded-full border border-purple-500/30 transition-colors"
            ...
            {/* Input */}
            <div className="p-4 bg-slate-100 dark:bg-slate-900 border-t border-purple-500/20">
              {errorMessage && (
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 bg-slate-200 dark:bg-slate-800 border border-purple-500/20 rounded-full text-sm focus:outline-none focus:border-purple-500 transition-colors"
                  disabled={isTyping} // Disable input when bot is typing
                />
                <motion.button
                  onClick={handleSend}
                  className="p-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full hover:shadow-lg transition-all disabled:opacity-50"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
