    ...
    <div className="fixed inset-0 pointer-events-none">
      <div className="absolute inset-0">
        ...
        <div
          ...
          className="absolute -bottom-10 right-20 w-96 h-96 bg-pink-500 rounded-full mix-blend-multiply filter blur-[128px] opacity-20 md:opacity-10 hidden sm:block"
        />
      </div>
