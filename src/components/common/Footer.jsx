...
const Footer = () => {
  ...
  return (
    <footer className="relative border-t-2 border-purple-500/40 py-12">
      {/* Background decoration */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute bottom-0 left-1/4 w-72 h-72 bg-purple-500 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-72 h-72 bg-pink-500 rounded-full blur-3xl" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-[var(--text-secondary)] dark:text-gray-400 hover:text-purple-400 transition-colors inline-block"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          >
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="p-3 bg-[var(--bg-card)] dark:bg-slate-800/50 rounded-lg border-2 border-purple-500/40 hover:border-purple-500/50 hover:bg-purple-500/10 transition-all"
            ...
            <motion.a
              href="#contact"
              className="mt-6 inline-flex items-center gap-2 px-4 py-2 bg-purple-500 hover:bg-purple-700 rounded-lg text-sm font-semibold transition-colors"
